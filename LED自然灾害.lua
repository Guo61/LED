...
Tabs.Misc:Button({
    Title = "更新脚本主页图片",
    Desc = "/storage/emulated/0/Delta/Workspace/WindUI/"
      Callback = function()
         setclipboard("/storage/emulated/0/Delta/Workspace/WindUI/")
        WindUI:Notify({Title = "已复制图片路径", Content = "请自行删除LEDHub文件夹", Duration = 3})
    end
})
